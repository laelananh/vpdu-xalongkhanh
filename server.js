...
app.use(session({
  secret: 'vpdu_long_khanh_secret_key_2026',
  resave: false,
...
app.get('/gioi-thieu', (req, res) => {
  res.render('about', {
    title: 'Giới Thiệu Văn phòng Đảng ủy Xã Long Khánh'
  });
});
...
app.get('/dich-vu-cong/tra-cuu', (req, res) => {
  ...
  if (code) {
    ...
    result = {
      ...
      department: 'Văn phòng Đảng ủy Xã Long Khánh'
    };
  }
...
app.listen(PORT, () => {
  console.log(`=======================================================`);
  console.log(` CỔNG THÔNG TIN ĐIỆN TỬ VĂN PHÒNG ĐẢNG UỶ XÃ LONG KHÁNH`);
