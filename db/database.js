...
const samplePosts = [
  {
    id: 1,
    title: 'Xã Long Khánh tổ chức thăm và trao quà cho các gia đình chính sách nhân ngày Thương binh - Liệt sĩ 27/7',
...
const sampleTenders = [
  {
    ...
    investor: 'Ủy ban nhân dân Xã Long Khánh',
    status: 'Đang mời thầu',
    field: 'Mua sắm hàng hóa',
    deadline: '2026-08-25 17:00:00',
    published_at: '2026-07-12 09:00:00',
    content: `Dự án trang bị cơ sở vật chất cho Nhà văn hóa cộng đồng Xã Long Khánh.`
  },
  {
    id: 2,
    code: 'GT-MT-2026-02',
...
const sampleServices = [
  {
    ...
    fee: 'Miễn phí',
    authority: 'Ủy ban nhân dân Xã Long Khánh',
...
module.exports = {
  ...
  createService: (data) => {
    ...
    const newService = {
      ...
      authority: data.authority || 'Ủy ban nhân dân Xã Long Khánh',
